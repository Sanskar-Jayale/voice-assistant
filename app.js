...
fridayComs.push("are you there - to check zoro presence");
...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    if (transcript.includes("tell about yourself")) {
      readOut(
        "sir, i am a zoro, a voice assistant made for browsers using javascript by Master Sameer and Master Sanskar. I can do anything which can be done from a browser."
      );
    }
